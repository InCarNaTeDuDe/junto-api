...
const initialChats: Chat[] = [
  {
    ...
    contextTitle: "Avengers: Endgame - 2 Tickets",
    unreadCount: 1,
    messages: [
      {
        id: "m-1",
        sender: "them",
        text: "Hi! Are the tickets still available?",
        timestamp: "10:30 AM",
      },
      {
        id: "m-2",
      ...
      },
      {
        id: "m-3",
        sender: "them",
        text: "Great! Can we meet near the theatre?",
        timestamp: "10:32 AM",
      },
      {
        id: "m-4",
        sender: "me",
        text: "Sure, I can be there by 7 PM.",
        timestamp: "10:33 AM",
      },
      {
        id: "m-5",
  ...
  },
  {
    ...
    category: "Day Mates",
    contextTitle: "Morning Walk Buddy",
    unreadCount: 1,
    messages: [
      {
        id: "m-6",
        sender: "them",
        text: "Great! See you tomorrow ☀️",
        timestamp: "9:30 PM",
      },
      {
        id: "m-7",
      ...
      },
      {
        id: "m-8",
        sender: "them",
        text: "Hi everyone! See you tomorrow at 6 AM! 🌟",
        timestamp: "9:20 PM",
      },
      {
        id: "m-9",
        sender: "me",
        text: "Hi Ananya! Yes, I am looking forward to it.",
        timestamp: "9:16 PM",
      },
      {
        id: "m-10",
        sender: "them",
        text: "Great! See you tomorrow at 6 AM sharp?",
        timestamp: "9:17 PM",
      },
      {
        id: "m-11",
        sender: "me",
        text: "Absolutely! See you there ☀️",
        timestamp: "9:18 PM",
      },
    ],
  },
  {
    ...
    category: "Lost & Found",
    contextTitle: "Black Wallet",
    unreadCount: 0,
    messages: [
      {
        id: "m-12",
        sender: "them",
        text: "Lost & Found • Black Wallet",
        timestamp: "8:45 PM",
      },
      {
        id: "m-13",
        sender: "them",
        text: "Please let me know if it's yours.",
        timestamp: "8:45 PM",
      },
    ],
  },
  {
    ...
    category: "Day Mates",
    contextTitle: "Coffee Near Bandra",
    unreadCount: 0,
    messages: [
      {
        id: "m-14",
        sender: "them",
        text: "Sure, I know a nice place!",
        timestamp: "Yesterday",
      },
    ],
  },
  {
    ...
    category: "Day Mates",
    contextTitle: "Badminton Game",
    unreadCount: 0,
    messages: [
      {
        id: "m-15",
        sender: "them",
        text: "I'll bring the racquets.",
        timestamp: "Yesterday",
      },
    ],
  },
